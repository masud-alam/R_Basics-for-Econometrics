#This is not a complete and a comprhensive file for conditional statements & function.
#Primary target is to give you some basic ideas or to just getting started with loops/conditional statements/functions
...
##Look at the following example;Put multiple action statements within braces
...
#here, the sequence is a vector and val takes on each of its value during the loop
...
greet <- sayHello("Econ 390A R programmers")
greet
